...
Abrir al iniciar tu jornada, elergir quien llama (Mr, Ms, hijo, hija, etc.), Motivo (basado en el tipo de compania y linea de negocio), Explicacion (pasos tomados para resolver), Resolucion (timeframes, resuelto completamente o no, pasos a seguir, etc.)
